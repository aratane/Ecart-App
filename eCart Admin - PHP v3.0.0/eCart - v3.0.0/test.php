...
// $pickup =  isset($_POST['pickup']) ? $db->escapeString($function->xss_clean($_POST['pickup'])) : "";

// if (isset($_POST['pickup']) && $_POST['pickup'] == 1 && !empty($_POST['pickup'])) {
//     $where = " AND o.local_pickup = 1";
// } elseif (isset($_POST['pickup']) || $_POST['pickup'] == 0) {
//     $where =  " AND o.local_pickup = 0";
// }
...
foreach ($res as $row) {
    ...
    $status1 = json_decode($res[$i]['status']);
