                        ...
                        <div id="variations">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">shipping_delivery : </label><?php echo isset($error['description']) ? $error['description'] : ''; ?>
                                        <textarea name="shipping_delivery" id="shipping_delivery" class="form-control" rows="16"><?php echo $data['shipping_delivery']; ?></textarea>
                                        <script type="text/javascript" src="css/js/ckeditor/ckeditor.js"></script>
                                        <script type="text/javascript">
